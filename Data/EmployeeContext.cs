...
namespace EmployeesCh12.Data
{
    public class EmployeeContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //one-to-many relationship between Location and Department Location.
            ...
            modelBuilder.Entity<Employee>().HasOne<Benefits>(p => p.Benefits).WithOne(s => s.Employee).HasForeignKey<Benefits>(b => b.EmployeeID);
        }
    }
}